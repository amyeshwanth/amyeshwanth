	   ...
	   <div style="height:550px;background-color:#9999ff;padding-top:0px;">
		...
		<div style="width:110%;margin-left:-5%;padding-left:15px;padding-top:10px;min-height:550px;background-color:#F2F3F4;">
            ...
            <div style="width:50%;float:left;padding-left:1px;">
				...
				<h1 style="font-weight:bolder;font-size:25px;color:black;text-align:left;">  Manage Applied  jobs </h1> <br><br>
				<?php

include('config.php');
session_start();

$result = mysqli_query($db,"SELECT * FROM apply where Cid='".$_SESSION['uname']."' ")or die(mysqli_error());
...
<th><font color='#4c4c4c'>Selected</font></th>
<th><font color='#4c4c4c'>Rejected</font></th>
...
echo '<td><b><font color="#663300"><a href="selectjob.php?id=' . $row['Userid'] . '">Select</a></font></b></td>';
echo '<td><b><font color="#663300"><a href="rejectjob.php?id=' . $row['Userid'] . '">Reject</a></font></b></td>';
