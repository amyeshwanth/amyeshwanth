   ...
   <div class="companies20-content">
     <div class="companies-wrapper">
	   ...
	   <div class="banner-item">
               ...
               <!-- banner -->
<div style="height:800px;background-color:#F2F3F4;">
<div style="width:40%;float:left;margin:0;background-color:#F2F3F4;">
			<img src="./assets/images/applyjob.jpeg" style="width:70%;height:300px;border-radius:65px;"/>
        </div>

        <div style="width:50%;float:left;padding-center:1px;height:500px;background-color:#F2F3F4;">
            	<form method="post" action="applyjobs.php">
				<div class="container" style="width:85%;float:center;height:715px;margin-top:15px;background-color:white;border:3px solid black;border-radius:15px;margin-left:-30px;">
				<table class="style1">
                    <tr>
                        <td>
                            &nbsp;</td>
                        ...
                        <td align="center" colspan="2">
                            <span style="font-weight:bolder;font-size:25px;color:black;">View Job </span></td>
                        <td>
                            &nbsp;</td>
                    </tr>
...
$result = mysqli_query($db,"SELECT * FROM Jobs where Jid='$id'")or die(mysqli_error());
...
<tr>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;
                        <input type="text" placeholder="Enter Job ID" id="jid" name="jid" value= "<?php echo $row['Jid']; ?>"style="border-style:solid;border-radius: 15px;"  />
                            &nbsp;</td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;
                        <input type="text" placeholder="Enter name" id="jname" name="jname" value= "<?php echo $row['Jname']; ?>" style="border-style:solid;border-radius: 15px;"  onchange="valuname()" />
                            &nbsp;</td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <input type="text" placeholder="" id="jdesc" name="jdesc" value= "<?php echo $row['Jdisc']; ?>" style="border-style:solid;border-radius: 15px;" />
                            &nbsp;</td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <input type="text" placeholder="" id="jpack" name="jpack" value= "<?php echo $row['Jpack']; ?>" style="border-style:solid;border-radius: 15px;"  />
                            &nbsp;</td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;
                        <input type="text" placeholder="" id="jloc" name="jloc" value= "<?php echo $row['Jloc']; ?>"style="border-style:solid;border-radius: 15px;"  />
                            &nbsp;</td>
                            &nbsp;</td>
                        <td>
                            &nbsp;</td>
                   ...
                   <tr>
                        ...
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <input id="logi" type="submit" value="Apply"style="height:35px;position:relative;left:-60px;background-color:#d5ec57;border-radius:35px;width:150px;" onclick="return validator();" /></td>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
