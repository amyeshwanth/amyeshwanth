	   ...
	   <div style="height:550px;background-color:#9999ff;padding-top:0px;">
		...
		<div style="width:110%;margin-left:-5%;padding-left:15px;padding-top:10px;min-height:550px;background-color:#F2F3F4;">
            ...
            <div style="width:50%;float:left;padding-left:1px;">
				...
				<h1 style="font-weight:bolder;font-size:25px;color:black;text-align:left;">  Approve the Student </h1> <br><br>
				<?php

include('config.php');

$result = mysqli_query($db,"SELECT * FROM student where Status='Pending'")or die(mysqli_error());
...
<th><font color='#4c4c4c'>Approve</font></th>
</tr>";
...
echo '<td><b><font color="#663300"><a href="approvedata.php?uid=' . $row['Userid'] . '">Approve</a></font></b></td>';
echo "</tr>";
