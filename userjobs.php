...
<!--<div style="width:100%;float:left;padding-left:15px;padding-top:10px;min-height:550px;background-color:#F2F3F4>-->
		<div style="width:110%;margin-left:-5%;padding-left:15px;padding-top:10px;min-height:550px;background-color:#F2F3F4;">
            ...
            <div style="width:50%;float:left;padding-left:1px;">
				...
				<h1 style="font-weight:bolder;font-size:25px;color:black;text-align:left;">  Manage the jobs </h1> <br><br>
				<?php

include('config.php');
session_start();

$result = mysqli_query($db,"SELECT * FROM jobs ")or die(mysqli_error());
...
echo '<td><b><font color="#663300"><a href="viewjobdata.php?id=' . $row['Jid'] . '">View</a></font></b></td>';
echo "</tr>";
