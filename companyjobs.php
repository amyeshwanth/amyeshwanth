...
include('config.php');
session_start();
$result = mysqli_query($db,"SELECT * FROM jobs where Cid='".$_SESSION['uname']."'")or die(mysqli_error());
...
echo '<td><b><font color="#663300"><a href="deletejobdata.php?id=' . $row['Jid'] . '">Delete</a></font></b></td>';
echo "</tr>";
