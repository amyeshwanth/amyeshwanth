...
$result = mysqli_query($db,"SELECT * FROM apply where Userid='".$_SESSION['uname']."' ")or die(mysqli_error());
...
echo '<td><b><font color="#663300"><a href="deletemyjob.php?id=' . $row['Jid'] . '">Delete</a></font></b></td>';
echo "</tr>";
